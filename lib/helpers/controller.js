...
function appendControllersStructure(controllers, globalFunctions){
  for (var i=0; i<controllers.length; i++){
    ...
    appendControllerPropAndFunctions(controllerMeta);
  }
}

function appendControllerPropAndFunctions(controllerMeta){
  //Traverse controller body
  //console.log('********** BEGIN Controller ' + controllerMeta.name + ' ****************');
  estraverse.traverse(controllerMeta.function.body, { enter: enterBuildControllerStructure(controllerMeta) });
