...
function getNodeValueFromBodyAndGlobals({ nodeIdentifier, bodyToAnalize, globalFunctions }){
  switch (nodeIdentifier.type) {
    ...
    default:
      throw new Error('Special type from nodeIdentifier in getNodeValueFromBodyAndGlobals');
  }
}
