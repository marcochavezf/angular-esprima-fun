...
function appendGlobalFunctions({ controllers, components, directives, services, filters, globalFunctions, globalVariables }){
...
function parse(ast){
  ...
  var localFileFunctions = [];
	...
	estraverse.traverse(ast, {
		enter: enterBuildFileStructure({ controllers, components, directives, services, filters, globalVariables, globalFunctions, localFileVariables, localFileFunctions }),
...
function enterBuildFileStructure({ controllers, components, directives, services, filters, globalVariables, globalFunctions, localFileVariables, localFileFunctions }) {
  return function(node) {
    ...
    if (fileHelper.isComponent(node)) {
      var component = {
        node: node,
        name: nodeName
      };
