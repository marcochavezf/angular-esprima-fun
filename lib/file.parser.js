...
function parse(ast){
  ...
  var localFileFunctions = [];
	...
	estraverse.traverse(ast, {
		enter: enterBuildFileStructure(controllers, globalVariables, globalFunctions, localFileVariables, localFileFunctions),
		leave: leaveBuildFileStructure
	});

	//Get controller body function/Class
  var possibleControllerFunctions = globalFunctions.concat(localFileFunctions);
  ctrlrHelper.appendControllersStructure(controllers, possibleControllerFunctions);
...
function enterBuildFileStructure(controllers, globalVariables, globalFunctions, localFileVariables, localFileFunctions) {
