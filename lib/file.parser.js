...
function appendGlobalFunctions({ controllers, directives, services, filters, globalFunctions }){
  ...
  directiveHelper.appendDirectiveStructure(directives, globalFunctions);
